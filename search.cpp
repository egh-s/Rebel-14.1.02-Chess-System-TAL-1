...
void Init_Nnue_Root(board_t* board, int nply);  // @Chris
void Nnue_Housekeeping(board_t* board, int move, undo_t undo, int nply);    // @Chris
...
void search() {
   ...
   Init_Nnue_Root(SearchCurrent->board, 0); // @Chris
